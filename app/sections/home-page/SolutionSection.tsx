  ...
  const cardData = [
    {
      ...
      alt: "easy image",
      title: "Easy Settings",
      text: "A complete about-face in core economic amsterday bilamco progressive.",
      ...
      <div className="flex flex-col-reverse xl:flex-row gap-[74px]">
        ...
        <div className="">
          <Typography
            tag="h2"
            mb
            text="A complete software solution for you."
          />
          <Typography
            tag="p"
            mb
            text="The source of powerful qorld and making future sure. Its a straight
                    forward software."
          />
          <Typography
            tag="p"
            text="Where possibilities are made possible. We must have expand
                    Possibilities of better tomorrow. The directly secure of your network
                    deliveing services."
          />
